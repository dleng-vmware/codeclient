...
LOCALE = 'fr'
Config_files = 'only_onlinepre.yml'
...
class Test_da4:
    ...
    def setup_class(self):
        ...
        I18N.add_config_file('only_onlinepre.yml')
    ...
    def test_l1(self):
        ...
        assert tran8 == "<html><body><p><span style=\"color: rgb(255,0,0);\"><strong>预定的维护已开始。</strong></span></p><p>有关维护的重要信息，可以在这里找到： <a class=\"external-link\" href=\"http://www.vmware.com\">https://www.vmware.com</a><strong><br/></strong></p></body></html>"
    ...
    def test_l10(self):
        ...
        assert trans1 == "test fr the 22 to 11 and 33"
        trans2 = translation1.get_string("contact", "contact.title", format_items={'x':'11', 'y' : '22', 'z':'33', 'p':'553'}, locale = 'ko')
