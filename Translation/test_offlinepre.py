...
PRODUCT = 'dtestproduct'
VERSION = '1.3'
COMPONENT = 'about'
LOCALE = 'fr'
Config_files = 'sample_offline_diskpre.yml'
...
class Test_da2:
    ...
    def setup_class(self):
        ...
        I18N.add_config_file('sample_offline_diskpre.yml')
    ...
    def test_l1(self):
        ...
        tran2 = translation.get_string("testcomponent1", "test_html_key", locale = 'de')
        print("tets html %s " %tran2)
        tran7 = translation.get_string("test-component4", "test_html_key", locale='de')
        print("test link %s" %tran7)
        tran3 = translation.get_string("testcomponent1", "test.copyright", locale='de')
        print("test coooo %s" %tran3)
        tran4 = translation.get_string("test-component4", "test-contact.key", locale='de')
        print("test link %s" %tran4)
        tran5 = translation.get_string("test_component2", "test_common-key", locale='fr')
        print("test common %s" %tran5)
        tran6 = translation.get_string("test.component3", "test_format.key1", locale='en')
        print("test common %s" %tran6)
        tran8 = translation.get_string("testcomponent1", "test_-html.key1", locale='zh-Hans')
        assert tran8 == "<html><body><p><span style=\"color: rgb(255,0,0);\"><strong>预定的维护已开始123。</strong></span></p><p>有关维护的重要信息，可以在这里找到： <a class=\"external-link\" href=\"http://www.vmware.com\">https://www.vmware.com</a><strong><br/></strong></p></body></html>"
        print("test html key %s" % tran8)
    ...
    def test_l5(self):
        ...
        self.rel = I18N.get_release(PRODUCT, VERSION)
        translation1 = self.rel.get_translation()
        trans1 = translation1.get_string("about", "about.message", source="123234", locale = "ja")
    ...
    def test_l7(self):
        ...
        self.rel = I18N.get_release(PRODUCT, VERSION)
        translation1 = self.rel.get_translation()
        trans2 = translation1.get_string("about","about.message",locale = "zh-Hans")
        print(trans2)
    ...
    @pytest.mark.ci1
    def test_l8(self):
        print("offline:component and key and nolocale or nosource")
        I18N.set_current_locale(LOCALE)
